...
from Statistic import load_json, keep_russian_letters, load_text
...
#                 if pos == -1:  # если больше не найдено
#                     break
#                 distances.add(pos - pre_pos)
#                 start = pos + length  # сдвигаем стартовую позицию
#                 pre_pos = pos
#     return distances
...
ciphertext = vigenere(plaintext, "КЛЮЧ")
f = find_repeats(p)
print(f)
# aaaa
# print(vigenere("привет", "ключ", 1))
# print(vigenere("ъьжърю", "ключ", 0))
